...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String OPEN_WEATHER_MAP_API = "84bee99ac17f578e9870dd99f54c6d83"; //""06e28d2e957905b4ccf827111543253a";
        ...
        mFusedLocationProviderClient.getLastLocation().addOnSuccessListener(MainActivity.this, new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if(location != null){
                    ...
                    humidityField.setText(String.format("Humidity : %s", jsonData[3]));
                    pressureField.setText(String.format("Pressure : %s", jsonData[4]));
    ...
    public String[] getJSONResponse(){
        ...
        try{
            if(jsonWeather != null){
                ...
                @SuppressLint("DefaultLocale") String temperature = String.format("%s°", String.format("%.0f", main.getDouble("temp")));
